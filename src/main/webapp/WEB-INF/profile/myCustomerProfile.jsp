...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/myCustomerProfile.css">
...
<div class = "myProfile-container">
	<div class="img-section">
        <img src="https://img.freepik.com/premium-photo/small-business-owner-working-his-cafe_484651-11545.jpg?semt=ais_hybrid&w=740&q=80" alt="Customer Profile">
    ...
    <div class="content-section">
        ...
        <div class="input-fields">
            <form action="<%= request.getContextPath() %>/CustomerServlet" class="update-profile-data" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="action" value="updateCustomerProfile">
                
                <!-- Profile Picture Preview -->
                <div class="profile-picture-preview">
                    <%
                        String profilePic = (String) request.getAttribute("customerProfilePic");
                        String profilePicPath = profilePic != null && !profilePic.isEmpty() ? 
                            request.getContextPath() + "/" + profilePic : 
                            request.getContextPath() + "/assets/profiles/default-customer.jpg";
                    %>
            ...
            <div class="Change-password">
                ...
                <form action="<%= request.getContextPath() %>/CustomerServlet" method="POST" id="passwordForm">
