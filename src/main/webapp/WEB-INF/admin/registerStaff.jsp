...
<head>
    ...
    <title>ABC Modern Kitchen - Staff Registration</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@400;600;700&family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/registerStaff.css">
...
<body>
    <div class="register-container">
        <div class="image-section">
            <img src="https://www.intechnic.com/hubfs/Blog/Featured%20Images/Best%20Restaurant%20Website%20Design%20Inspirations.jpg" alt="Staff Registration">
            <div class="image-overlay">
                <div class="image-text">
                    <h1>Join Our Team</h1>
                    <p>Become part of ABC Modern Kitchen's professional staff</p>
                </div>
            </div>
        </div>
